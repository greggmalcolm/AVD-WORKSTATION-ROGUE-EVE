...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.252.108/24 | 198.18.252.1 |
...
| --------- | --------------- | ------------ | --------- |
| AS_BL1_2 | Vlan4094 | 10.255.255.12 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_AS-BL1_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_AS-BL1_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet5 |  To DCI Switches | trunk | 210-240 | - | - | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AS-SPINE1_Ethernet6 | routed | - | 198.18.201.29/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AS-SPINE2_Ethernet6 | routed | - | 198.18.201.31/31 | default | 1500 | false | - | - |
...
interface Ethernet2
   ...
   mtu 1500
   no switchport
   ip address 198.18.201.31/31
!
interface Ethernet3
   description MLAG_PEER_AS-BL1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_AS-BL1_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   ...
   no shutdown
   switchport trunk allowed vlan 210-240
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_AS-BL1_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_AS-BL1_Po3
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 198.18.10.10/32 |
...
| Vlan3009 |  PROD  |  10.255.254.13/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  DEV  |  10.255.254.13/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.254.13/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.255.13/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 10.255.254.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| 198.18.201.28 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.30 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.255.254.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | DEV | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
| 10.255.254.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 198.18.10.10:10110 | 10110:10110 | - | - | learned |
| 120 | 198.18.10.10:10120 | 10120:10120 | - | - | learned |
| 210 | 198.18.10.10:10210 | 10210:10210 | - | - | learned |
| 220 | 198.18.10.10:10220 | 10220:10220 | - | - | learned |
| 230 | 198.18.10.10:10230 | 10230:10230 | - | - | learned |
| 240 | 198.18.10.10:10240 | 10240:10240 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 198.18.10.10:20 | connected |
| PROD | 198.18.10.10:10 | connected |
...
router bgp 65003
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description AS-BL1
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 Arista789!
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.255.254.12 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.254.12 description AS-BL1
   ...
   neighbor 198.18.201.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.28 remote-as 65100
   neighbor 198.18.201.28 description AS-SPINE1_Ethernet6
   neighbor 198.18.201.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.30 remote-as 65100
   neighbor 198.18.201.30 description AS-SPINE2_Ethernet6
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 110
      rd 198.18.10.10:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 120
      rd 198.18.10.10:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 210
      rd 198.18.10.10:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 220
      rd 198.18.10.10:10220
      route-target both 10220:10220
      redistribute learned
   !
   vlan 230
      rd 198.18.10.10:10230
      route-target both 10230:10230
      redistribute learned
   !
   vlan 240
      rd 198.18.10.10:10240
