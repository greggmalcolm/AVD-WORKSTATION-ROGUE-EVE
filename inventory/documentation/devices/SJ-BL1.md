...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.251.107/24 | 198.18.251.1 |
...
| --------- | --------------- | ------------ | --------- |
| SJ_BL1_2 | Vlan4094 | 10.255.252.13 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_SJ-BL2_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_SJ-BL2_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SJ-SPINE1_Ethernet5 | routed | - | 198.18.200.25/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SJ-SPINE2_Ethernet5 | routed | - | 198.18.200.27/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_SJ-SPINE1_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 198.18.200.25/31
!
interface Ethernet2
   description P2P_LINK_TO_SJ-SPINE2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 198.18.200.27/31
!
interface Ethernet3
   description MLAG_PEER_SJ-BL2_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_SJ-BL2_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_SJ-BL2_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_SJ-BL2_Po3
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 198.18.0.9/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 198.18.1.9/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 198.18.0.9/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 198.18.1.9/32
```
...
| 198.18.200.24 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.200.26 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 198.18.0.9:10010 | 10010:10010 | - | - | learned |
| 20 | 198.18.0.9:10020 | 10020:10020 | - | - | learned |
| 210 | 198.18.0.9:10210 | 10210:10210 | - | - | learned |
| 220 | 198.18.0.9:10220 | 10220:10220 | - | - | learned |
| 230 | 198.18.0.9:10230 | 10230:10230 | - | - | learned |
| 240 | 198.18.0.9:10240 | 10240:10240 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 198.18.0.9:20 | connected |
| PROD | 198.18.0.9:10 | connected |
...
router bgp 65003
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description SJ-BL2
   ...
   neighbor 10.255.251.13 description SJ-BL2
   ...
   neighbor 198.18.200.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.200.24 remote-as 65000
   neighbor 198.18.200.24 description SJ-SPINE1_Ethernet5
   neighbor 198.18.200.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.200.26 remote-as 65000
   neighbor 198.18.200.26 description SJ-SPINE2_Ethernet5
