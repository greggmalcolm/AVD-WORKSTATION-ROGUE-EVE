...
| --------- | --------------- | ------------ | --------- |
| AVD_BORDER_LEAF | Vlan4094 | 10.255.252.12 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_AVD-VEOS7_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_AVD-VEOS7_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet5 |  Routed interface to IOL22 | access | - | - | - | - |
| Ethernet6 | switch32_Gi0/1 | *trunk | *1-1023 | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-VEOS1_Ethernet6 | routed | - | 172.31.255.29/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-VEOS2_Ethernet6 | routed | - | 172.31.255.31/31 | default | 1500 | false | - | - |
| Ethernet5 | Routed interface to IOL22 | switchport | - | 10.100.1.4/31 | PROD | - | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-VEOS1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-VEOS2_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_AVD-VEOS7_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_AVD-VEOS7_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_AVD-VEOS7_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_AVD-VEOS7_Po3
   no shutdown
   switchport
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 10 | 10.255.255.8 | enabled | Ethernet5 <br> vlan 10 <br> vlan 20 <br> | disabled | default | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.255.10:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.255.10:10020 | 10020:10020 | - | - | learned |
| 110 | 192.168.255.10:10110 | 10110:10110 | - | - | learned |
| 120 | 192.168.255.10:10120 | 10120:10120 | - | - | learned |
| 210 | 192.168.255.10:10210 | 10210:10210 | - | - | learned |
| 220 | 192.168.255.10:10220 | 10220:10220 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 192.168.255.10:20 | connected |
| PROD | 192.168.255.10:10 | connected |
...
router bgp 65201
   ...
   !
   vlan 10
      rd 192.168.255.10:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 110
      rd 192.168.255.10:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 120
      rd 192.168.255.10:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 20
      rd 192.168.255.10:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 210
      rd 192.168.255.10:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 220
      rd 192.168.255.10:10220
