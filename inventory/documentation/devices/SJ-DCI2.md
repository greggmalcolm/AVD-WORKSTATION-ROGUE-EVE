...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.99.108/24 | 198.18.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| SJ_DCI1_2 | Vlan4094 | 10.255.252.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_SJ-DCI1_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_SJ-DCI1_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SJ-SPINE1_Ethernet4 | routed | - | 198.18.200.21/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SJ-SPINE2_Ethernet4 | routed | - | 198.18.200.23/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_AS-DCI2_Ethernet5 | routed | - | 10.255.250.4/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_SJ-SPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 198.18.200.21/31
!
interface Ethernet2
   description P2P_LINK_TO_SJ-SPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 198.18.200.23/31
!
interface Ethernet3
   description MLAG_PEER_SJ-DCI1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_SJ-DCI1_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description P2P_LINK_TO_AS-DCI2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_SJ-DCI1_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_SJ-DCI1_Po3
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 198.18.0.8/32 |
...
| Vlan3009 |  PROD  |  10.255.251.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  DEV  |  10.255.251.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 10.255.250.5 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 198.18.10.8 | 65102 | default | - | Inherited from peer group DCI-OVERLAY-PEERS | Inherited from peer group DCI-OVERLAY-PEERS | - | Inherited from peer group DCI-OVERLAY-PEERS | - |
| 198.18.200.20 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.200.22 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | DEV | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 198.18.0.8:10010 | 10010:10010 | - | - | learned |
| 20 | 198.18.0.8:10020 | 10020:10020 | - | - | learned |
| 110 | 198.18.0.8:10110 | 10110:10110 | - | - | learned |
| 120 | 198.18.0.8:10120 | 10120:10120 | - | - | learned |
| 210 | 198.18.0.8:10210 | 10210:10210 | - | - | learned |
| 220 | 198.18.0.8:10220 | 10220:10220 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 198.18.0.8:20 | connected |
| PROD | 198.18.0.8:10 | connected |
...
router bgp 65002
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description SJ-DCI1
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 vnEaG8gMeQf3d3cN6PktXQ==
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.255.250.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.250.5 remote-as 65102
   neighbor 10.255.250.5 description AS-DCI2
   neighbor 10.255.251.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.8 description SJ-DCI1
   ...
   neighbor 198.18.10.8 peer group DCI-OVERLAY-PEERS
   neighbor 198.18.10.8 remote-as 65102
   neighbor 198.18.10.8 description AS-DCI2
   neighbor 198.18.200.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.200.20 remote-as 65000
   neighbor 198.18.200.20 description SJ-SPINE1_Ethernet4
   neighbor 198.18.200.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.200.22 remote-as 65000
   neighbor 198.18.200.22 description SJ-SPINE2_Ethernet4
