...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.252.103/24 | 198.18.252.1 |
...
| --------- | --------------- | ------------ | --------- |
| AS_LEAF1_2 | Vlan4094 | 10.255.255.5 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_AS-LEAF2_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_AS-LEAF2_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AS-SPINE1_Ethernet1 | routed | - | 198.18.201.9/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AS-SPINE2_Ethernet1 | routed | - | 198.18.201.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AS-SPINE1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 198.18.201.9/31
!
interface Ethernet2
   description P2P_LINK_TO_AS-SPINE2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 198.18.201.11/31
!
interface Ethernet3
   description MLAG_PEER_AS-LEAF2_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_AS-LEAF2_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet6
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_AS-LEAF2_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_AS-LEAF2_Po3
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 198.18.10.5/32 |
...
| Vlan3009 |  PROD  |  10.255.254.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  DEV  |  10.255.254.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.254.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 10.255.254.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| 198.18.201.8 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.10 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.255.254.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | DEV | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
| 10.255.254.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 198.18.10.5:10110 | 10110:10110 | - | - | learned |
| 120 | 198.18.10.5:10120 | 10120:10120 | - | - | learned |
| 210 | 198.18.10.5:10210 | 10210:10210 | - | - | learned |
| 220 | 198.18.10.5:10220 | 10220:10220 | - | - | learned |
| 230 | 198.18.10.5:10230 | 10230:10230 | - | - | learned |
| 240 | 198.18.10.5:10240 | 10240:10240 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 198.18.10.5:20 | connected |
| PROD | 198.18.10.5:10 | connected |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description AS-LEAF2
   ...
   neighbor 10.255.254.5 description AS-LEAF2
   ...
   neighbor 198.18.201.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.8 remote-as 65100
   neighbor 198.18.201.8 description AS-SPINE1_Ethernet1
   neighbor 198.18.201.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.10 remote-as 65100
   neighbor 198.18.201.10 description AS-SPINE2_Ethernet1
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 110
      rd 198.18.10.5:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 120
      rd 198.18.10.5:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 210
      rd 198.18.10.5:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 220
      rd 198.18.10.5:10220
      route-target both 10220:10220
      redistribute learned
   !
   vlan 230
      rd 198.18.10.5:10230
      route-target both 10230:10230
      redistribute learned
   !
   vlan 240
      rd 198.18.10.5:10240
