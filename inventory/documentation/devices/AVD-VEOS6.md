...
| --------- | --------------- | ------------ | --------- |
| AVD_POD2 | Vlan4094 | 10.255.252.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_AVD-VEOS5_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_AVD-VEOS5_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet6 | switch31_Gi0/1 | *trunk | *1-1023 | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-VEOS1_Ethernet4 | routed | - | 172.31.255.21/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-VEOS2_Ethernet4 | routed | - | 172.31.255.23/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-VEOS1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-VEOS2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_AVD-VEOS5_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_AVD-VEOS5_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet6
   description switch31_Gi0/1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_AVD-VEOS5_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | switch31_Switch31 | switched | trunk | 1-1023 | - | - | 90 | static | 6 | - |
...
interface Port-Channel3
   description MLAG_PEER_AVD-VEOS5_Po3
   no shutdown
   switchport
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.255.8:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.255.8:10020 | 10020:10020 | - | - | learned |
| 110 | 192.168.255.8:10110 | 10110:10110 | - | - | learned |
| 120 | 192.168.255.8:10120 | 10120:10120 | - | - | learned |
| 210 | 192.168.255.8:10210 | 10210:10210 | - | - | learned |
| 220 | 192.168.255.8:10220 | 10220:10220 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| DEV | 192.168.255.8:20 | connected |
| PROD | 192.168.255.8:10 | connected |
