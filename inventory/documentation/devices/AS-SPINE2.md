...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.98.102/24 | 198.18.98.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AS-LEAF1_Ethernet2 | routed | - | 198.18.201.10/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AS-LEAF2_Ethernet2 | routed | - | 198.18.201.14/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_AS-DCI1_Ethernet2 | routed | - | 198.18.201.18/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AS-DCI2_Ethernet2 | routed | - | 198.18.201.22/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_AS-LEAF3_Ethernet2 | routed | - | 198.18.201.26/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_AS-LEAF4_Ethernet2 | routed | - | 198.18.201.30/31 | default | 1500 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_AS-DCI1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_AS-DCI2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 198.18.10.2/32 |
...
| 198.18.10.9 | 65103 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
| 198.18.10.10 | 65103 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
| 198.18.201.11 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.15 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.19 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.23 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.27 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 198.18.201.31 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65100
   ...
   neighbor 198.18.10.9 remote-as 65103
   neighbor 198.18.10.9 description AS-LEAF3
   neighbor 198.18.10.10 peer group EVPN-OVERLAY-PEERS
   neighbor 198.18.10.10 remote-as 65103
   neighbor 198.18.10.10 description AS-LEAF4
   ...
   neighbor 198.18.201.19 description AS-DCI1_Ethernet2
   neighbor 198.18.201.23 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.23 remote-as 65102
   neighbor 198.18.201.23 description AS-DCI2_Ethernet2
   neighbor 198.18.201.27 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.27 remote-as 65103
   neighbor 198.18.201.27 description AS-LEAF3_Ethernet2
   neighbor 198.18.201.31 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.201.31 remote-as 65103
   neighbor 198.18.201.31 description AS-LEAF4_Ethernet2
