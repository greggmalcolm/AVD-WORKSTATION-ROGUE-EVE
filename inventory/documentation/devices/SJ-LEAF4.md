...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.251.106/24 | 198.18.251.1 |
...
| --------- | --------------- | ------------ | --------- |
| SJ_LEAF3_4 | Vlan4094 | 10.255.252.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_SJ-LEAF3_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_SJ-LEAF3_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
!
interface Ethernet3
   description MLAG_PEER_SJ-LEAF3_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_SJ-LEAF3_Ethernet4
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_SJ-LEAF3_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_SJ-LEAF3_Po3
   no shutdown
   switchport
...
| 230 | 198.18.0.8:10230 | 10230:10230 | - | - | learned |
| 240 | 198.18.0.8:10240 | 10240:10240 | - | - | learned |
...
router bgp 65002
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description SJ-LEAF3
   ...
   neighbor 10.255.251.8 description SJ-LEAF3
